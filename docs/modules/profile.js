    ...
    <div class="card">
      ...
      <div class="grid cols2">
        <div class="card" style="box-shadow:none">
          ...
          <div class="field"><label>Email (pour code Pro)</label><input id="email" inputmode="email" value="${esc(p.email||"")}"/></div>
          ...
          <div class="field">
            ...
            <select id="lifeStage">
              ${opt("none","Aucun")}
              ${opt("menstruation","Menstruations")}
              ${opt("pregnancy","Grossesse")}
              ${opt("postpartum","Post-partum")}
              ${opt("menopause","Ménopause")}
              ${opt("andropause","Andropause")}
            </select>
          </div>
          <div class="row">
